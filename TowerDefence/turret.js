class RawTurret{
    constructor(_image, _sizeX, _sizeY, _effect){
        this.image = _image;
...
class Turret{
    ...
    constructor(_img, _x, _y){
        ...
        this.sprite.onMouseOver = () => {
            ...
            LayerManager.Layers.HUDLayer.circle(this.sprite.position.x, this.sprite.position.y, 500);
        }
    ...
    refreshTurret(){
        ...
        if(GameManager.allZombies.length > 0){
            ...
            if(closestD < 250 && frameCount % 120 == 0){
